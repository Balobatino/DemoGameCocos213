 ...
 */
@ccclass("ListenAndRepeatPageUIReference")
...
/**
 * ListenAndRepeatPage: Singleton that manages the listen and repeat UI page.
 */
@ccclass
export class ListenAndRepeatPage extends Singleton<ListenAndRepeatPage> {
    //------------------------------
