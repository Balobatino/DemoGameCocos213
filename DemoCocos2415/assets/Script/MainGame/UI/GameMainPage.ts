...
class UIReference {
    ...
    public playGameButton: cc.Button | null = null;

    @property({ type: cc.Button })
    public settingsButton: cc.Button | null = null;
}
...
export class GameMainPage extends Singleton<GameMainPage> {
    ...
    private registerButtonHandlers(): void {
        ...
        if (playBtn) {
            playBtn.node.on(cc.Node.EventType.TOUCH_END, this.onPlayGameButtonClicked, this);
        } else {
        ...
        if (settingsBtn) {
            settingsBtn.node.on(cc.Node.EventType.TOUCH_END, this.onSettingsButtonClicked, this);
        } else {
    ...
    protected onDestroy(): void {
        const playBtn = this.uiRef.playGameButton;
        if (playBtn) {
            playBtn.node.off(cc.Node.EventType.TOUCH_END, this.onPlayGameButtonClicked, this);
        }
        const settingsBtn = this.uiRef.settingsButton;
        if (settingsBtn) {
            settingsBtn.node.off(cc.Node.EventType.TOUCH_END, this.onSettingsButtonClicked, this);
        }
    }
}
