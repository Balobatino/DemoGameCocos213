...
export class UIElementMoveAnimation extends BaseUIElementAnimation {
    ...
    @property
    public defaultPosition: cc.Vec2 = new cc.Vec2(0, 0);
    ...
    @property
    public showFrom: cc.Vec2 = new cc.Vec2(0, 0);

    @property
    public showTo: cc.Vec2 = new cc.Vec2(0, 0);
    ...
    @property
    public hideFrom: cc.Vec2 = new cc.Vec2(0, 0);

    @property
    public hideTo: cc.Vec2 = new cc.Vec2(0, 0);
    ...
    protected start(): void {
        ...
        this.defaultPosition = new cc.Vec2(p.x, p.y);
    }
    ...
    public show(onComplete?: () => void): void {
        ...
        const fromPos = new cc.Vec2(this.defaultPosition.x + fromOffset.x, this.defaultPosition.y + fromOffset.y);
        const toPos = new cc.Vec2(this.defaultPosition.x + toOffset.x, this.defaultPosition.y + toOffset.y);
        ...
        const t = cc
            ...
            .to(this.showDuration, { position: new cc.Vec3(toPos.x, toPos.y, z) }, { easing: EasingMap.get(this.showEasing) })
            .call(() => {
                this._activeTween = null;
    ...
    public hide(onComplete?: () => void): void {
        ...
        const t = cc
            ...
            .to(this.hideDuration, { position: new cc.Vec3(toPos.x, toPos.y, z) }, { easing: EasingMap.get(this.hideEasing) })
            .call(() => {
                this._activeTween = null;
                if (onComplete) onComplete();
            });
